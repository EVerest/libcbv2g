...
static int encode_iso2_ServiceType(exi_bitstream_t* stream, const struct iso2_ServiceType* ServiceType) {
    ...
    while(!done)
    {
        ...
        case 57:
            ...
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (unsignedShort); next=58
                error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
                if (error == EXI_ERROR__NO_ERROR)
                {
        ...
        case 58:
            ...
            if (ServiceType->ServiceName_isUsed == 1u)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (ServiceName, string); next=59
            ...
            else
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (ServiceCategory, string); next=60
                    error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
        ...
        case 60:
            ...
            if (ServiceType->ServiceScope_isUsed == 1u)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (ServiceScope, string); next=61
    ...
    while(!done)
    {
        ...
        case 66:
            ...
            if (Certificate_currentIndex < SubCertificatesType->Certificate.arrayLen)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (base64Binary); next=67
                    error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        error = exi_basetypes_encoder_uint_16(stream, (uint16_t)SubCertificatesType->Certificate.array[Certificate_currentIndex].bytesLen);
...
static int encode_iso2_DC_EVSEStatusType(exi_bitstream_t* stream, const struct iso2_DC_EVSEStatusType* DC_EVSEStatusType) {
    ...
    while(!done)
    {
        ...
        case 85:
            ...
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (unsignedInt); next=86
                error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
                if (error == EXI_ERROR__NO_ERROR)
                {
        ...
        case 87:
            ...
            if (DC_EVSEStatusType->EVSEIsolationStatus_isUsed == 1u)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (EVSEIsolationStatus, string); next=88
                    error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
...
static int encode_iso2_AC_EVSEStatusType(exi_bitstream_t* stream, const struct iso2_AC_EVSEStatusType* AC_EVSEStatusType) {
    ...
    while(!done)
    {
        ...
        case 89:
            ...
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (unsignedInt); next=90
                error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
                if (error == EXI_ERROR__NO_ERROR)
                {
...
static int encode_iso2_EVSEStatusType(exi_bitstream_t* stream, const struct iso2_EVSEStatusType* EVSEStatusType) {
    ...
    while(!done)
    {
        ...
        case 92:
            ...
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (unsignedInt); next=93
                error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
                if (error == EXI_ERROR__NO_ERROR)
                {
        ...
        case 94:
            ...
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (EVSEStatusType); next=95
...
static int encode_iso2_ConsumptionCostType(exi_bitstream_t* stream, const struct iso2_ConsumptionCostType* ConsumptionCostType) {
    ...
    while(!done)
    {
        ...
        case 99:
            ...
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (PhysicalValueType); next=100
    ...
    while(!done)
    {
        ...
        case 103:
            ...
            if (PMaxScheduleEntryType->RelativeTimeInterval_isUsed == 1u)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (RelativeTimeInterval, IntervalType); next=104
            ...
            else
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Abstract element or type: START (IntervalType); next=104
    ...
    while(!done)
    {
        ...
        case 105:
            ...
            if (SalesTariffEntryType->RelativeTimeInterval_isUsed == 1u)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (RelativeTimeInterval, IntervalType); next=106
            ...
            else
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Abstract element or type: START (IntervalType); next=106
        ...
        case 106:
            ...
            if (SalesTariffEntryType->EPriceLevel_isUsed == 1u)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (EPriceLevel, unsignedShort); next=109
                    error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
            ...
            else if (ConsumptionCost_currentIndex < SalesTariffEntryType->ConsumptionCost.arrayLen)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (ConsumptionCost, ConsumptionCostType); next=107 (optional array)
        ...
        case 107:
            ...
            if (ConsumptionCost_currentIndex < SalesTariffEntryType->ConsumptionCost.arrayLen)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (ConsumptionCost, ConsumptionCostType); next=108 (optional array)
                    error = encode_iso2_ConsumptionCostType(stream, &SalesTariffEntryType->ConsumptionCost.array[ConsumptionCost_currentIndex++]);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        grammar_id = 108;
        ...
        case 109:
            ...
            if (ConsumptionCost_currentIndex < SalesTariffEntryType->ConsumptionCost.arrayLen)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (ConsumptionCost, ConsumptionCostType); next=110 (optional array)
                    error = encode_iso2_ConsumptionCostType(stream, &SalesTariffEntryType->ConsumptionCost.array[ConsumptionCost_currentIndex++]);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        grammar_id = 110;
        ...
        case 110:
            ...
            if (ConsumptionCost_currentIndex < SalesTariffEntryType->ConsumptionCost.arrayLen)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (ConsumptionCost, ConsumptionCostType); next=111 (optional array)
                    error = encode_iso2_ConsumptionCostType(stream, &SalesTariffEntryType->ConsumptionCost.array[ConsumptionCost_currentIndex++]);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        grammar_id = 111;
    ...
    while(!done)
    {
        ...
        case 127:
            ...
            if (SalesTariffType->Id_isUsed == 1u)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (Id, NCName); next=128
            ...
            else
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (SalesTariffID, unsignedByte); next=129
                    error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
        ...
        case 128:
            ...
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (unsignedByte); next=129
                error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
                if (error == EXI_ERROR__NO_ERROR)
                {
                    error = exi_basetypes_encoder_nbit_uint(stream, 8, (uint32_t)SalesTariffType->SalesTariffID - 1);
        ...
        case 129:
            ...
            if (SalesTariffType->SalesTariffDescription_isUsed == 1u)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (SalesTariffDescription, string); next=142
            ...
            else if (SalesTariffType->NumEPriceLevels_isUsed == 1u)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (NumEPriceLevels, unsignedShort); next=155
                    error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
        ...
        case 136:
            ...
            if (SalesTariffEntry_currentIndex < SalesTariffType->SalesTariffEntry.arrayLen)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (EntryType); next=137
                    error = encode_iso2_SalesTariffEntryType(stream, &SalesTariffType->SalesTariffEntry.array[SalesTariffEntry_currentIndex++]);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        grammar_id = 137;
        ...
        case 137:
            ...
            if (SalesTariffEntry_currentIndex < SalesTariffType->SalesTariffEntry.arrayLen)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (EntryType); next=138
                    error = encode_iso2_SalesTariffEntryType(stream, &SalesTariffType->SalesTariffEntry.array[SalesTariffEntry_currentIndex++]);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        grammar_id = 138;
        ...
        case 138:
            ...
            if (SalesTariffEntry_currentIndex < SalesTariffType->SalesTariffEntry.arrayLen)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (EntryType); next=139
                    error = encode_iso2_SalesTariffEntryType(stream, &SalesTariffType->SalesTariffEntry.array[SalesTariffEntry_currentIndex++]);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        grammar_id = 139;
        ...
        case 139:
            ...
            if (SalesTariffEntry_currentIndex < SalesTariffType->SalesTariffEntry.arrayLen)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (EntryType); next=140
                    error = encode_iso2_SalesTariffEntryType(stream, &SalesTariffType->SalesTariffEntry.array[SalesTariffEntry_currentIndex++]);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        grammar_id = 140;
        ...
        case 140:
            ...
            if (SalesTariffEntry_currentIndex < SalesTariffType->SalesTariffEntry.arrayLen)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (EntryType); next=141
                    error = encode_iso2_SalesTariffEntryType(stream, &SalesTariffType->SalesTariffEntry.array[SalesTariffEntry_currentIndex++]);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        grammar_id = 141;
        ...
        case 142:
            ...
            else
            {
                if (SalesTariffEntry_currentIndex < SalesTariffType->SalesTariffEntry.arrayLen)
                {
                    ...
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        // Event: START (EntryType); next=143
                        error = encode_iso2_SalesTariffEntryType(stream, &SalesTariffType->SalesTariffEntry.array[SalesTariffEntry_currentIndex++]);
                        if (error == EXI_ERROR__NO_ERROR)
                        {
                            grammar_id = 143;
        ...
        case 143:
            ...
            if (SalesTariffEntry_currentIndex < SalesTariffType->SalesTariffEntry.arrayLen)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (EntryType); next=144
                    error = encode_iso2_SalesTariffEntryType(stream, &SalesTariffType->SalesTariffEntry.array[SalesTariffEntry_currentIndex++]);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        grammar_id = 144;
        ...
        case 144:
            ...
            if (SalesTariffEntry_currentIndex < SalesTariffType->SalesTariffEntry.arrayLen)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (EntryType); next=145
                    error = encode_iso2_SalesTariffEntryType(stream, &SalesTariffType->SalesTariffEntry.array[SalesTariffEntry_currentIndex++]);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        grammar_id = 145;
        ...
        case 145:
            ...
            if (SalesTariffEntry_currentIndex < SalesTariffType->SalesTariffEntry.arrayLen)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (EntryType); next=146
                    error = encode_iso2_SalesTariffEntryType(stream, &SalesTariffType->SalesTariffEntry.array[SalesTariffEntry_currentIndex++]);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        grammar_id = 146;
        ...
        case 146:
            ...
            if (SalesTariffEntry_currentIndex < SalesTariffType->SalesTariffEntry.arrayLen)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (EntryType); next=147
                    error = encode_iso2_SalesTariffEntryType(stream, &SalesTariffType->SalesTariffEntry.array[SalesTariffEntry_currentIndex++]);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        grammar_id = 147;
        ...
        case 147:
            ...
            if (SalesTariffEntry_currentIndex < SalesTariffType->SalesTariffEntry.arrayLen)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (EntryType); next=148
                    error = encode_iso2_SalesTariffEntryType(stream, &SalesTariffType->SalesTariffEntry.array[SalesTariffEntry_currentIndex++]);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        grammar_id = 148;
        ...
        case 149:
            ...
            if (SalesTariffEntry_currentIndex < SalesTariffType->SalesTariffEntry.arrayLen)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (EntryType); next=150
                    error = encode_iso2_SalesTariffEntryType(stream, &SalesTariffType->SalesTariffEntry.array[SalesTariffEntry_currentIndex++]);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        grammar_id = 150;
        ...
        case 150:
            ...
            if (SalesTariffEntry_currentIndex < SalesTariffType->SalesTariffEntry.arrayLen)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (EntryType); next=151
                    error = encode_iso2_SalesTariffEntryType(stream, &SalesTariffType->SalesTariffEntry.array[SalesTariffEntry_currentIndex++]);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        grammar_id = 151;
        ...
        case 151:
            ...
            if (SalesTariffEntry_currentIndex < SalesTariffType->SalesTariffEntry.arrayLen)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (EntryType); next=152
                    error = encode_iso2_SalesTariffEntryType(stream, &SalesTariffType->SalesTariffEntry.array[SalesTariffEntry_currentIndex++]);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        grammar_id = 152;
        ...
        case 152:
            ...
            if (SalesTariffEntry_currentIndex < SalesTariffType->SalesTariffEntry.arrayLen)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (EntryType); next=153
                    error = encode_iso2_SalesTariffEntryType(stream, &SalesTariffType->SalesTariffEntry.array[SalesTariffEntry_currentIndex++]);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        grammar_id = 153;
        ...
        case 153:
            ...
            if (SalesTariffEntry_currentIndex < SalesTariffType->SalesTariffEntry.arrayLen)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (EntryType); next=154
                    error = encode_iso2_SalesTariffEntryType(stream, &SalesTariffType->SalesTariffEntry.array[SalesTariffEntry_currentIndex++]);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        grammar_id = 154;
        ...
        case 155:
            ...
            if (SalesTariffEntry_currentIndex < SalesTariffType->SalesTariffEntry.arrayLen)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (EntryType); next=156
                    error = encode_iso2_SalesTariffEntryType(stream, &SalesTariffType->SalesTariffEntry.array[SalesTariffEntry_currentIndex++]);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        grammar_id = 156;
        ...
        case 157:
            ...
            if (SalesTariffEntry_currentIndex < SalesTariffType->SalesTariffEntry.arrayLen)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (EntryType); next=158
                    error = encode_iso2_SalesTariffEntryType(stream, &SalesTariffType->SalesTariffEntry.array[SalesTariffEntry_currentIndex++]);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        grammar_id = 158;
        ...
        case 158:
            ...
            if (SalesTariffEntry_currentIndex < SalesTariffType->SalesTariffEntry.arrayLen)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (EntryType); next=159
                    error = encode_iso2_SalesTariffEntryType(stream, &SalesTariffType->SalesTariffEntry.array[SalesTariffEntry_currentIndex++]);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        grammar_id = 159;
        ...
        case 159:
            ...
            if (SalesTariffEntry_currentIndex < SalesTariffType->SalesTariffEntry.arrayLen)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (EntryType); next=160
                    error = encode_iso2_SalesTariffEntryType(stream, &SalesTariffType->SalesTariffEntry.array[SalesTariffEntry_currentIndex++]);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        grammar_id = 160;
        ...
        case 160:
            ...
            if (SalesTariffEntry_currentIndex < SalesTariffType->SalesTariffEntry.arrayLen)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (EntryType); next=161
                    error = encode_iso2_SalesTariffEntryType(stream, &SalesTariffType->SalesTariffEntry.array[SalesTariffEntry_currentIndex++]);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        grammar_id = 161;
        ...
        case 161:
            ...
            if (SalesTariffEntry_currentIndex < SalesTariffType->SalesTariffEntry.arrayLen)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (EntryType); next=162
                    error = encode_iso2_SalesTariffEntryType(stream, &SalesTariffType->SalesTariffEntry.array[SalesTariffEntry_currentIndex++]);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        grammar_id = 162;
        ...
        case 162:
            ...
            if (SalesTariffEntry_currentIndex < SalesTariffType->SalesTariffEntry.arrayLen)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (EntryType); next=163
                    error = encode_iso2_SalesTariffEntryType(stream, &SalesTariffType->SalesTariffEntry.array[SalesTariffEntry_currentIndex++]);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        grammar_id = 163;
        ...
        case 163:
            ...
            if (SalesTariffEntry_currentIndex < SalesTariffType->SalesTariffEntry.arrayLen)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (EntryType); next=164
                    error = encode_iso2_SalesTariffEntryType(stream, &SalesTariffType->SalesTariffEntry.array[SalesTariffEntry_currentIndex++]);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        grammar_id = 164;
        ...
        case 164:
            ...
            if (SalesTariffEntry_currentIndex < SalesTariffType->SalesTariffEntry.arrayLen)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (EntryType); next=165
                    error = encode_iso2_SalesTariffEntryType(stream, &SalesTariffType->SalesTariffEntry.array[SalesTariffEntry_currentIndex++]);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        grammar_id = 165;
        ...
        case 165:
            ...
            if (SalesTariffEntry_currentIndex < SalesTariffType->SalesTariffEntry.arrayLen)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (EntryType); next=166
                    error = encode_iso2_SalesTariffEntryType(stream, &SalesTariffType->SalesTariffEntry.array[SalesTariffEntry_currentIndex++]);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        grammar_id = 166;
        ...
        case 166:
            ...
            if (SalesTariffEntry_currentIndex < SalesTariffType->SalesTariffEntry.arrayLen)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (EntryType); next=167
                    error = encode_iso2_SalesTariffEntryType(stream, &SalesTariffType->SalesTariffEntry.array[SalesTariffEntry_currentIndex++]);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        grammar_id = 167;
...
static int encode_iso2_ProfileEntryType(exi_bitstream_t* stream, const struct iso2_ProfileEntryType* ProfileEntryType) {
    ...
    while(!done)
    {
        ...
        case 185:
            ...
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (unsignedLong); next=186
                error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
                if (error == EXI_ERROR__NO_ERROR)
                {
...
static int encode_iso2_SAScheduleTupleType(exi_bitstream_t* stream, const struct iso2_SAScheduleTupleType* SAScheduleTupleType) {
    ...
    while(!done)
    {
        ...
        case 188:
            ...
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (unsignedByte); next=189
                error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
                if (error == EXI_ERROR__NO_ERROR)
                {
        ...
        case 189:
            ...
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (PMaxScheduleType); next=190
    ...
    while(!done)
    {
        ...
        case 191:
            ...
            if (CertificateChainType->Id_isUsed == 1u)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (Id, NCName); next=192
            ...
            else
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (Certificate, base64Binary); next=193
                    error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
        ...
        case 192:
            ...
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (base64Binary); next=193
                error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
                if (error == EXI_ERROR__NO_ERROR)
                {
                    error = exi_basetypes_encoder_uint_16(stream, (uint16_t)CertificateChainType->Certificate.bytesLen);
    ...
    while(!done)
    {
        ...
        case 194:
            ...
            if (SelectedService_currentIndex < SelectedServiceListType->SelectedService.arrayLen)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (SelectedServiceType); next=195
        ...
        case 195:
            ...
            if (SelectedService_currentIndex < SelectedServiceListType->SelectedService.arrayLen)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (SelectedServiceType); next=196
                    error = encode_iso2_SelectedServiceType(stream, &SelectedServiceListType->SelectedService.array[SelectedService_currentIndex++]);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        grammar_id = 196;
        ...
        case 196:
            ...
            if (SelectedService_currentIndex < SelectedServiceListType->SelectedService.arrayLen)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (SelectedServiceType); next=197
                    error = encode_iso2_SelectedServiceType(stream, &SelectedServiceListType->SelectedService.array[SelectedService_currentIndex++]);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        grammar_id = 197;
        ...
        case 197:
            ...
            if (SelectedService_currentIndex < SelectedServiceListType->SelectedService.arrayLen)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (SelectedServiceType); next=198
                    error = encode_iso2_SelectedServiceType(stream, &SelectedServiceListType->SelectedService.array[SelectedService_currentIndex++]);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        grammar_id = 198;
        ...
        case 198:
            ...
            if (SelectedService_currentIndex < SelectedServiceListType->SelectedService.arrayLen)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (SelectedServiceType); next=199
                    error = encode_iso2_SelectedServiceType(stream, &SelectedServiceListType->SelectedService.array[SelectedService_currentIndex++]);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        grammar_id = 199;
        ...
        case 199:
            ...
            if (SelectedService_currentIndex < SelectedServiceListType->SelectedService.arrayLen)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (SelectedServiceType); next=200
                    error = encode_iso2_SelectedServiceType(stream, &SelectedServiceListType->SelectedService.array[SelectedService_currentIndex++]);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        grammar_id = 200;
        ...
        case 200:
            ...
            if (SelectedService_currentIndex < SelectedServiceListType->SelectedService.arrayLen)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (SelectedServiceType); next=201
                    error = encode_iso2_SelectedServiceType(stream, &SelectedServiceListType->SelectedService.array[SelectedService_currentIndex++]);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        grammar_id = 201;
        ...
        case 201:
            ...
            if (SelectedService_currentIndex < SelectedServiceListType->SelectedService.arrayLen)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (SelectedServiceType); next=202
                    error = encode_iso2_SelectedServiceType(stream, &SelectedServiceListType->SelectedService.array[SelectedService_currentIndex++]);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        grammar_id = 202;
        ...
        case 202:
            ...
            if (SelectedService_currentIndex < SelectedServiceListType->SelectedService.arrayLen)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (SelectedServiceType); next=203
                    error = encode_iso2_SelectedServiceType(stream, &SelectedServiceListType->SelectedService.array[SelectedService_currentIndex++]);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        grammar_id = 203;
        ...
        case 203:
            ...
            if (SelectedService_currentIndex < SelectedServiceListType->SelectedService.arrayLen)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (SelectedServiceType); next=204
                    error = encode_iso2_SelectedServiceType(stream, &SelectedServiceListType->SelectedService.array[SelectedService_currentIndex++]);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        grammar_id = 204;
        ...
        case 204:
            ...
            if (SelectedService_currentIndex < SelectedServiceListType->SelectedService.arrayLen)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (SelectedServiceType); next=205
                    error = encode_iso2_SelectedServiceType(stream, &SelectedServiceListType->SelectedService.array[SelectedService_currentIndex++]);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        grammar_id = 205;
        ...
        case 205:
            ...
            if (SelectedService_currentIndex < SelectedServiceListType->SelectedService.arrayLen)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (SelectedServiceType); next=206
                    error = encode_iso2_SelectedServiceType(stream, &SelectedServiceListType->SelectedService.array[SelectedService_currentIndex++]);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        grammar_id = 206;
        ...
        case 206:
            ...
            if (SelectedService_currentIndex < SelectedServiceListType->SelectedService.arrayLen)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (SelectedServiceType); next=207
                    error = encode_iso2_SelectedServiceType(stream, &SelectedServiceListType->SelectedService.array[SelectedService_currentIndex++]);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        grammar_id = 207;
        ...
        case 207:
            ...
            if (SelectedService_currentIndex < SelectedServiceListType->SelectedService.arrayLen)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (SelectedServiceType); next=208
                    error = encode_iso2_SelectedServiceType(stream, &SelectedServiceListType->SelectedService.array[SelectedService_currentIndex++]);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        grammar_id = 208;
        ...
        case 208:
            ...
            if (SelectedService_currentIndex < SelectedServiceListType->SelectedService.arrayLen)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (SelectedServiceType); next=209
                    error = encode_iso2_SelectedServiceType(stream, &SelectedServiceListType->SelectedService.array[SelectedService_currentIndex++]);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        grammar_id = 209;
    ...
    while(!done)
    {
        ...
        case 210:
            ...
            if (RootCertificateID_currentIndex < ListOfRootCertificateIDsType->RootCertificateID.arrayLen)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (X509IssuerSerialType); next=211
        ...
        case 211:
            ...
            if (RootCertificateID_currentIndex < ListOfRootCertificateIDsType->RootCertificateID.arrayLen)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (X509IssuerSerialType); next=212
                    error = encode_iso2_X509IssuerSerialType(stream, &ListOfRootCertificateIDsType->RootCertificateID.array[RootCertificateID_currentIndex++]);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        grammar_id = 212;
        ...
        case 212:
            ...
            if (RootCertificateID_currentIndex < ListOfRootCertificateIDsType->RootCertificateID.arrayLen)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (X509IssuerSerialType); next=213
                    error = encode_iso2_X509IssuerSerialType(stream, &ListOfRootCertificateIDsType->RootCertificateID.array[RootCertificateID_currentIndex++]);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        grammar_id = 213;
        ...
        case 213:
            ...
            if (RootCertificateID_currentIndex < ListOfRootCertificateIDsType->RootCertificateID.arrayLen)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (X509IssuerSerialType); next=214
                    error = encode_iso2_X509IssuerSerialType(stream, &ListOfRootCertificateIDsType->RootCertificateID.array[RootCertificateID_currentIndex++]);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        grammar_id = 214;
        ...
        case 214:
            ...
            if (RootCertificateID_currentIndex < ListOfRootCertificateIDsType->RootCertificateID.arrayLen)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (X509IssuerSerialType); next=215
                    error = encode_iso2_X509IssuerSerialType(stream, &ListOfRootCertificateIDsType->RootCertificateID.array[RootCertificateID_currentIndex++]);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        grammar_id = 215;
    ...
    while(!done)
    {
        ...
        case 218:
            ...
            if (SignatureType->Id_isUsed == 1u)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (Id, NCName); next=219
            ...
            else
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (SignedInfo, SignedInfoType); next=220
        ...
        case 219:
            ...
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (SignedInfoType); next=220
                error = encode_iso2_SignedInfoType(stream, &SignatureType->SignedInfo);
                if (error == EXI_ERROR__NO_ERROR)
                {
                    grammar_id = 220;
        ...
        case 220:
            ...
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (base64Binary); next=221
        ...
        case 221:
            ...
            if (SignatureType->KeyInfo_isUsed == 1u)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (KeyInfo, KeyInfoType); next=223
            ...
            else if (SignatureType->Object_isUsed == 1u)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (Object, ObjectType); next=222
        ...
        case 223:
            ...
            if (SignatureType->Object_isUsed == 1u)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (Object, ObjectType); next=224
                    error = encode_iso2_ObjectType(stream, &SignatureType->Object);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        grammar_id = 224;
    ...
    while(!done)
    {
        ...
        case 227:
            ...
            if (ParameterSet_currentIndex < ServiceParameterListType->ParameterSet.arrayLen)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (ParameterSetType); next=228
                    error = encode_iso2_ParameterSetType(stream, &ServiceParameterListType->ParameterSet.array[ParameterSet_currentIndex++]);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        grammar_id = 228;
        ...
        case 228:
            ...
            if (ParameterSet_currentIndex < ServiceParameterListType->ParameterSet.arrayLen)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (ParameterSetType); next=229
                    error = encode_iso2_ParameterSetType(stream, &ServiceParameterListType->ParameterSet.array[ParameterSet_currentIndex++]);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        grammar_id = 229;
        ...
        case 229:
            ...
            if (ParameterSet_currentIndex < ServiceParameterListType->ParameterSet.arrayLen)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (ParameterSetType); next=230
                    error = encode_iso2_ParameterSetType(stream, &ServiceParameterListType->ParameterSet.array[ParameterSet_currentIndex++]);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        grammar_id = 230;
    ...
    while(!done)
    {
        ...
        case 231:
            ...
            if (DC_EVChargeParameterType->DepartureTime_isUsed == 1u)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (DepartureTime, unsignedLong); next=232
                    error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
            ...
            else
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (DC_EVStatus, EVStatusType); next=233
        ...
        case 232:
            ...
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (EVStatusType); next=233
                error = encode_iso2_DC_EVStatusType(stream, &DC_EVChargeParameterType->DC_EVStatus);
                if (error == EXI_ERROR__NO_ERROR)
                {
                    grammar_id = 233;
        ...
        case 233:
            ...
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (PhysicalValueType); next=234
        ...
        case 234:
            ...
            if (DC_EVChargeParameterType->EVMaximumPowerLimit_isUsed == 1u)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (EVMaximumPowerLimit, PhysicalValueType); next=235
            ...
            else
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (EVMaximumVoltageLimit, PhysicalValueType); next=236
        ...
        case 235:
            ...
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (PhysicalValueType); next=236
                error = encode_iso2_PhysicalValueType(stream, &DC_EVChargeParameterType->EVMaximumVoltageLimit);
                if (error == EXI_ERROR__NO_ERROR)
                {
                    grammar_id = 236;
        ...
        case 236:
            ...
            if (DC_EVChargeParameterType->EVEnergyCapacity_isUsed == 1u)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (EVEnergyCapacity, PhysicalValueType); next=237
            ...
            else if (DC_EVChargeParameterType->EVEnergyRequest_isUsed == 1u)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (EVEnergyRequest, PhysicalValueType); next=238
            ...
            else if (DC_EVChargeParameterType->FullSOC_isUsed == 1u)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (FullSOC, byte); next=239
                    error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
    ...
    while(!done)
    {
        ...
        case 240:
            ...
            if (AC_EVChargeParameterType->DepartureTime_isUsed == 1u)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (DepartureTime, unsignedLong); next=241
                    error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
            ...
            else
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (EAmount, PhysicalValueType); next=242
        ...
        case 241:
            ...
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (PhysicalValueType); next=242
                error = encode_iso2_PhysicalValueType(stream, &AC_EVChargeParameterType->EAmount);
                if (error == EXI_ERROR__NO_ERROR)
                {
                    grammar_id = 242;
        ...
        case 242:
            ...
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (PhysicalValueType); next=243
        ...
        case 243:
            ...
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (PhysicalValueType); next=244
    ...
    while(!done)
    {
        ...
        case 245:
            ...
            if (EVChargeParameterType->DepartureTime_isUsed == 1u)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (DepartureTime, unsignedLong); next=246
                    error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
            ...
            else
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (DC_EVChargeParameter, EVChargeParameterType); next=247
        ...
        case 246:
            ...
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (EVChargeParameterType); next=247
                error = encode_iso2_DC_EVChargeParameterType(stream, &EVChargeParameterType->DC_EVChargeParameter);
                if (error == EXI_ERROR__NO_ERROR)
                {
                    grammar_id = 247;
    ...
    while(!done)
    {
        ...
        case 254:
            ...
            if (ProfileEntry_currentIndex < ChargingProfileType->ProfileEntry.arrayLen)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (ProfileEntryType); next=255
                    error = encode_iso2_ProfileEntryType(stream, &ChargingProfileType->ProfileEntry.array[ProfileEntry_currentIndex++]);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        grammar_id = 255;
        ...
        case 255:
            ...
            if (ProfileEntry_currentIndex < ChargingProfileType->ProfileEntry.arrayLen)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (ProfileEntryType); next=256
                    error = encode_iso2_ProfileEntryType(stream, &ChargingProfileType->ProfileEntry.array[ProfileEntry_currentIndex++]);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        grammar_id = 256;
        ...
        case 256:
            ...
            if (ProfileEntry_currentIndex < ChargingProfileType->ProfileEntry.arrayLen)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (ProfileEntryType); next=257
                    error = encode_iso2_ProfileEntryType(stream, &ChargingProfileType->ProfileEntry.array[ProfileEntry_currentIndex++]);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        grammar_id = 257;
        ...
        case 257:
            ...
            if (ProfileEntry_currentIndex < ChargingProfileType->ProfileEntry.arrayLen)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (ProfileEntryType); next=258
                    error = encode_iso2_ProfileEntryType(stream, &ChargingProfileType->ProfileEntry.array[ProfileEntry_currentIndex++]);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        grammar_id = 258;
        ...
        case 258:
            ...
            if (ProfileEntry_currentIndex < ChargingProfileType->ProfileEntry.arrayLen)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (ProfileEntryType); next=259
                    error = encode_iso2_ProfileEntryType(stream, &ChargingProfileType->ProfileEntry.array[ProfileEntry_currentIndex++]);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        grammar_id = 259;
        ...
        case 259:
            ...
            if (ProfileEntry_currentIndex < ChargingProfileType->ProfileEntry.arrayLen)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (ProfileEntryType); next=260
                    error = encode_iso2_ProfileEntryType(stream, &ChargingProfileType->ProfileEntry.array[ProfileEntry_currentIndex++]);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        grammar_id = 260;
        ...
        case 260:
            ...
            if (ProfileEntry_currentIndex < ChargingProfileType->ProfileEntry.arrayLen)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (ProfileEntryType); next=261
                    error = encode_iso2_ProfileEntryType(stream, &ChargingProfileType->ProfileEntry.array[ProfileEntry_currentIndex++]);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        grammar_id = 261;
        ...
        case 261:
            ...
            if (ProfileEntry_currentIndex < ChargingProfileType->ProfileEntry.arrayLen)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (ProfileEntryType); next=262
                    error = encode_iso2_ProfileEntryType(stream, &ChargingProfileType->ProfileEntry.array[ProfileEntry_currentIndex++]);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        grammar_id = 262;
        ...
        case 262:
            ...
            if (ProfileEntry_currentIndex < ChargingProfileType->ProfileEntry.arrayLen)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (ProfileEntryType); next=263
                    error = encode_iso2_ProfileEntryType(stream, &ChargingProfileType->ProfileEntry.array[ProfileEntry_currentIndex++]);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        grammar_id = 263;
        ...
        case 263:
            ...
            if (ProfileEntry_currentIndex < ChargingProfileType->ProfileEntry.arrayLen)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (ProfileEntryType); next=264
                    error = encode_iso2_ProfileEntryType(stream, &ChargingProfileType->ProfileEntry.array[ProfileEntry_currentIndex++]);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        grammar_id = 264;
        ...
        case 264:
            ...
            if (ProfileEntry_currentIndex < ChargingProfileType->ProfileEntry.arrayLen)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (ProfileEntryType); next=265
                    error = encode_iso2_ProfileEntryType(stream, &ChargingProfileType->ProfileEntry.array[ProfileEntry_currentIndex++]);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        grammar_id = 265;
        ...
        case 265:
            ...
            if (ProfileEntry_currentIndex < ChargingProfileType->ProfileEntry.arrayLen)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (ProfileEntryType); next=266
                    error = encode_iso2_ProfileEntryType(stream, &ChargingProfileType->ProfileEntry.array[ProfileEntry_currentIndex++]);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        grammar_id = 266;
        ...
        case 266:
            ...
            if (ProfileEntry_currentIndex < ChargingProfileType->ProfileEntry.arrayLen)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (ProfileEntryType); next=267
                    error = encode_iso2_ProfileEntryType(stream, &ChargingProfileType->ProfileEntry.array[ProfileEntry_currentIndex++]);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        grammar_id = 267;
        ...
        case 267:
            ...
            if (ProfileEntry_currentIndex < ChargingProfileType->ProfileEntry.arrayLen)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (ProfileEntryType); next=268
                    error = encode_iso2_ProfileEntryType(stream, &ChargingProfileType->ProfileEntry.array[ProfileEntry_currentIndex++]);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        grammar_id = 268;
        ...
        case 268:
            ...
            if (ProfileEntry_currentIndex < ChargingProfileType->ProfileEntry.arrayLen)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (ProfileEntryType); next=269
                    error = encode_iso2_ProfileEntryType(stream, &ChargingProfileType->ProfileEntry.array[ProfileEntry_currentIndex++]);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        grammar_id = 269;
        ...
        case 269:
            ...
            if (ProfileEntry_currentIndex < ChargingProfileType->ProfileEntry.arrayLen)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (ProfileEntryType); next=270
                    error = encode_iso2_ProfileEntryType(stream, &ChargingProfileType->ProfileEntry.array[ProfileEntry_currentIndex++]);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        grammar_id = 270;
        ...
        case 270:
            ...
            if (ProfileEntry_currentIndex < ChargingProfileType->ProfileEntry.arrayLen)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (ProfileEntryType); next=271
                    error = encode_iso2_ProfileEntryType(stream, &ChargingProfileType->ProfileEntry.array[ProfileEntry_currentIndex++]);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        grammar_id = 271;
    ...
    while(!done)
    {
        ...
        case 272:
            ...
            if (SAScheduleTuple_currentIndex < SAScheduleListType->SAScheduleTuple.arrayLen)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (SAScheduleTupleType); next=273
        ...
        case 273:
            ...
            if (SAScheduleTuple_currentIndex < SAScheduleListType->SAScheduleTuple.arrayLen)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (SAScheduleTupleType); next=274
                    error = encode_iso2_SAScheduleTupleType(stream, &SAScheduleListType->SAScheduleTuple.array[SAScheduleTuple_currentIndex++]);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        grammar_id = 274;
    ...
    while(!done)
    {
        ...
        case 276:
            ...
            if (ChargeServiceType->ServiceName_isUsed == 1u)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (ServiceName, string); next=277
            ...
            else
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (ServiceCategory, string); next=278
                    error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
        ...
        case 278:
            ...
            if (ChargeServiceType->ServiceScope_isUsed == 1u)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (ServiceScope, string); next=279
            ...
            else
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (FreeService, boolean); next=280
                    error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
...
static int encode_iso2_DC_EVPowerDeliveryParameterType(exi_bitstream_t* stream, const struct iso2_DC_EVPowerDeliveryParameterType* DC_EVPowerDeliveryParameterType) {
    ...
    while(!done)
    {
        ...
        case 283:
            ...
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (EVStatusType); next=284
        ...
        case 284:
            ...
            if (DC_EVPowerDeliveryParameterType->BulkChargingComplete_isUsed == 1u)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (BulkChargingComplete, boolean); next=285
                    error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
...
static int encode_iso2_DC_EVSEChargeParameterType(exi_bitstream_t* stream, const struct iso2_DC_EVSEChargeParameterType* DC_EVSEChargeParameterType) {
    ...
    while(!done)
    {
        ...
        case 286:
            ...
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (EVSEStatusType); next=287
        ...
        case 287:
            ...
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (PhysicalValueType); next=288
        ...
        case 289:
            ...
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (PhysicalValueType); next=290
        ...
        case 290:
            ...
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (PhysicalValueType); next=291
        ...
        case 291:
            ...
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (PhysicalValueType); next=292
        ...
        case 292:
            ...
            if (DC_EVSEChargeParameterType->EVSECurrentRegulationTolerance_isUsed == 1u)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (EVSECurrentRegulationTolerance, PhysicalValueType); next=293
            ...
            else
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (EVSEPeakCurrentRipple, PhysicalValueType); next=294
        ...
        case 293:
            ...
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (PhysicalValueType); next=294
                error = encode_iso2_PhysicalValueType(stream, &DC_EVSEChargeParameterType->EVSEPeakCurrentRipple);
                if (error == EXI_ERROR__NO_ERROR)
                {
                    grammar_id = 294;
...
static int encode_iso2_AC_EVSEChargeParameterType(exi_bitstream_t* stream, const struct iso2_AC_EVSEChargeParameterType* AC_EVSEChargeParameterType) {
    ...
    while(!done)
    {
        ...
        case 295:
            ...
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (EVSEStatusType); next=296
        ...
        case 296:
            ...
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (PhysicalValueType); next=297
    ...
    while(!done)
    {
        ...
        case 298:
            ...
            if (Service_currentIndex < ServiceListType->Service.arrayLen)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (ServiceType); next=299
        ...
        case 299:
            ...
            if (Service_currentIndex < ServiceListType->Service.arrayLen)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (ServiceType); next=300
                    error = encode_iso2_ServiceType(stream, &ServiceListType->Service.array[Service_currentIndex++]);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        grammar_id = 300;
        ...
        case 300:
            ...
            if (Service_currentIndex < ServiceListType->Service.arrayLen)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (ServiceType); next=301
                    error = encode_iso2_ServiceType(stream, &ServiceListType->Service.array[Service_currentIndex++]);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        grammar_id = 301;
        ...
        case 301:
            ...
            if (Service_currentIndex < ServiceListType->Service.arrayLen)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (ServiceType); next=302
                    error = encode_iso2_ServiceType(stream, &ServiceListType->Service.array[Service_currentIndex++]);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        grammar_id = 302;
        ...
        case 302:
            ...
            if (Service_currentIndex < ServiceListType->Service.arrayLen)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (ServiceType); next=303
                    error = encode_iso2_ServiceType(stream, &ServiceListType->Service.array[Service_currentIndex++]);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        grammar_id = 303;
        ...
        case 303:
            ...
            if (Service_currentIndex < ServiceListType->Service.arrayLen)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (ServiceType); next=304
                    error = encode_iso2_ServiceType(stream, &ServiceListType->Service.array[Service_currentIndex++]);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        grammar_id = 304;
        ...
        case 304:
            ...
            if (Service_currentIndex < ServiceListType->Service.arrayLen)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (ServiceType); next=305
                    error = encode_iso2_ServiceType(stream, &ServiceListType->Service.array[Service_currentIndex++]);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        grammar_id = 305;
    ...
    while(!done)
    {
        ...
        case 309:
            ...
            if (MeterInfoType->MeterReading_isUsed == 1u)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (MeterReading, nonNegativeInteger); next=310
                    error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
            ...
            else if (MeterInfoType->SigMeterReading_isUsed == 1u)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (SigMeterReading, base64Binary); next=311
                    error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
            ...
            else if (MeterInfoType->MeterStatus_isUsed == 1u)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (MeterStatus, short); next=312
                    error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
...
static int encode_iso2_MessageHeaderType(exi_bitstream_t* stream, const struct iso2_MessageHeaderType* MessageHeaderType) {
    ...
    while(!done)
    {
        ...
        case 315:
            ...
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (hexBinary); next=316
                error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
                if (error == EXI_ERROR__NO_ERROR)
                {
        ...
        case 316:
            ...
            if (MessageHeaderType->Notification_isUsed == 1u)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (Notification, NotificationType); next=317
    ...
    while(!done)
    {
        ...
        case 321:
            ...
            if (AuthorizationReqType->Id_isUsed == 1u)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (Id, NCName); next=322
...
static int encode_iso2_CableCheckResType(exi_bitstream_t* stream, const struct iso2_CableCheckResType* CableCheckResType) {
    ...
    while(!done)
    {
        ...
        case 324:
            ...
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (EVSEStatusType); next=325
...
static int encode_iso2_CurrentDemandReqType(exi_bitstream_t* stream, const struct iso2_CurrentDemandReqType* CurrentDemandReqType) {
    ...
    while(!done)
    {
        ...
        case 326:
            ...
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (EVStatusType); next=327
        ...
        case 327:
            ...
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (PhysicalValueType); next=328
        ...
        case 328:
            ...
            if (CurrentDemandReqType->EVMaximumVoltageLimit_isUsed == 1u)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (EVMaximumVoltageLimit, PhysicalValueType); next=329
            ...
            else if (CurrentDemandReqType->EVMaximumCurrentLimit_isUsed == 1u)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (EVMaximumCurrentLimit, PhysicalValueType); next=330
            ...
            else if (CurrentDemandReqType->EVMaximumPowerLimit_isUsed == 1u)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (EVMaximumPowerLimit, PhysicalValueType); next=331
            ...
            else if (CurrentDemandReqType->BulkChargingComplete_isUsed == 1u)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (BulkChargingComplete, boolean); next=332
                    error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
            ...
            else
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (ChargingComplete, boolean); next=333
                    error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
        ...
        case 333:
            ...
            if (CurrentDemandReqType->RemainingTimeToFullSoC_isUsed == 1u)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (RemainingTimeToFullSoC, PhysicalValueType); next=334
            ...
            else if (CurrentDemandReqType->RemainingTimeToBulkSoC_isUsed == 1u)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (RemainingTimeToBulkSoC, PhysicalValueType); next=335
    ...
    while(!done)
    {
        ...
        case 337:
            ...
            if (ServiceDiscoveryReqType->ServiceScope_isUsed == 1u)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (ServiceScope, string); next=338
...
static int encode_iso2_WeldingDetectionResType(exi_bitstream_t* stream, const struct iso2_WeldingDetectionResType* WeldingDetectionResType) {
    ...
    while(!done)
    {
        ...
        case 341:
            ...
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (EVSEStatusType); next=342
...
static int encode_iso2_PreChargeReqType(exi_bitstream_t* stream, const struct iso2_PreChargeReqType* PreChargeReqType) {
    ...
    while(!done)
    {
        ...
        case 346:
            ...
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (EVStatusType); next=347
        ...
        case 347:
            ...
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (PhysicalValueType); next=348
...
static int encode_iso2_ServiceDetailResType(exi_bitstream_t* stream, const struct iso2_ServiceDetailResType* ServiceDetailResType) {
    ...
    while(!done)
    {
        ...
        case 353:
            ...
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (unsignedShort); next=354
                error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
                if (error == EXI_ERROR__NO_ERROR)
                {
    ...
    while(!done)
    {
        ...
        case 355:
            ...
            if (ChargeParameterDiscoveryReqType->MaxEntriesSAScheduleTuple_isUsed == 1u)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (MaxEntriesSAScheduleTuple, unsignedInt); next=356
                    error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
            ...
            else
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (RequestedEnergyTransferMode, string); next=357
                    error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
...
static int encode_iso2_CertificateInstallationResType(exi_bitstream_t* stream, const struct iso2_CertificateInstallationResType* CertificateInstallationResType) {
    ...
    while(!done)
    {
        ...
        case 359:
            ...
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (CertificateChainType); next=360
        ...
        case 360:
            ...
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (CertificateChainType); next=361
        ...
        case 361:
            ...
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (privateKeyType); next=362
        ...
        case 362:
            ...
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (dHpublickeyType); next=363
...
static int encode_iso2_ChargingStatusResType(exi_bitstream_t* stream, const struct iso2_ChargingStatusResType* ChargingStatusResType) {
    ...
    while(!done)
    {
        ...
        case 366:
            ...
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (unsignedByte); next=367
                error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
                if (error == EXI_ERROR__NO_ERROR)
                {
        ...
        case 367:
            ...
            if (ChargingStatusResType->EVSEMaxCurrent_isUsed == 1u)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (EVSEMaxCurrent, PhysicalValueType); next=368
            ...
            else if (ChargingStatusResType->MeterInfo_isUsed == 1u)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (MeterInfo, MeterInfoType); next=369
            ...
            else if (ChargingStatusResType->ReceiptRequired_isUsed == 1u)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (ReceiptRequired, boolean); next=370
                    error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
...
static int encode_iso2_CertificateUpdateResType(exi_bitstream_t* stream, const struct iso2_CertificateUpdateResType* CertificateUpdateResType) {
    ...
    while(!done)
    {
        ...
        case 372:
            ...
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (CertificateChainType); next=373
        ...
        case 373:
            ...
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (CertificateChainType); next=374
        ...
        case 374:
            ...
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (privateKeyType); next=375
        ...
        case 375:
            ...
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (dHpublickeyType); next=376
        ...
        case 376:
            ...
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (eMAIDType); next=377
...
static int encode_iso2_CurrentDemandResType(exi_bitstream_t* stream, const struct iso2_CurrentDemandResType* CurrentDemandResType) {
    ...
    while(!done)
    {
        ...
        case 379:
            ...
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (EVSEStatusType); next=380
        ...
        case 380:
            ...
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (PhysicalValueType); next=381
        ...
        case 381:
            ...
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (PhysicalValueType); next=382
        ...
        case 385:
            ...
            if (CurrentDemandResType->EVSEMaximumVoltageLimit_isUsed == 1u)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (EVSEMaximumVoltageLimit, PhysicalValueType); next=386
            ...
            else if (CurrentDemandResType->EVSEMaximumCurrentLimit_isUsed == 1u)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (EVSEMaximumCurrentLimit, PhysicalValueType); next=387
            ...
            else if (CurrentDemandResType->EVSEMaximumPowerLimit_isUsed == 1u)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (EVSEMaximumPowerLimit, PhysicalValueType); next=388
            ...
            else
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (EVSEID, string); next=389
        ...
        case 389:
            ...
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (unsignedByte); next=390
                error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
                if (error == EXI_ERROR__NO_ERROR)
                {
        ...
        case 390:
            ...
            if (CurrentDemandResType->MeterInfo_isUsed == 1u)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (MeterInfo, MeterInfoType); next=391
...
static int encode_iso2_PreChargeResType(exi_bitstream_t* stream, const struct iso2_PreChargeResType* PreChargeResType) {
    ...
    while(!done)
    {
        ...
        case 398:
            ...
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (EVSEStatusType); next=399
...
static int encode_iso2_CertificateInstallationReqType(exi_bitstream_t* stream, const struct iso2_CertificateInstallationReqType* CertificateInstallationReqType) {
    ...
    while(!done)
    {
        ...
        case 401:
            ...
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (base64Binary); next=402
                error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
                if (error == EXI_ERROR__NO_ERROR)
                {
    ...
    while(!done)
    {
        ...
        case 403:
            ...
            if (MeteringReceiptReqType->Id_isUsed == 1u)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (Id, NCName); next=404
            ...
            else
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (SessionID, hexBinary); next=405
                    error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
        ...
        case 404:
            ...
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (hexBinary); next=405
                error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
                if (error == EXI_ERROR__NO_ERROR)
                {
                    error = exi_basetypes_encoder_uint_16(stream, (uint16_t)MeteringReceiptReqType->SessionID.bytesLen);
        ...
        case 405:
            ...
            if (MeteringReceiptReqType->SAScheduleTupleID_isUsed == 1u)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (SAScheduleTupleID, unsignedByte); next=406
                    error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
...
static int encode_iso2_PaymentDetailsResType(exi_bitstream_t* stream, const struct iso2_PaymentDetailsResType* PaymentDetailsResType) {
    ...
    while(!done)
    {
        ...
        case 408:
            ...
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (base64Binary); next=409
                error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
                if (error == EXI_ERROR__NO_ERROR)
                {
...
static int encode_iso2_CertificateUpdateReqType(exi_bitstream_t* stream, const struct iso2_CertificateUpdateReqType* CertificateUpdateReqType) {
    ...
    while(!done)
    {
        ...
        case 411:
            ...
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (CertificateChainType); next=412
...
static int encode_iso2_PowerDeliveryReqType(exi_bitstream_t* stream, const struct iso2_PowerDeliveryReqType* PowerDeliveryReqType) {
    ...
    while(!done)
    {
        ...
        case 416:
            ...
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (unsignedByte); next=417
                error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
                if (error == EXI_ERROR__NO_ERROR)
                {
        ...
        case 417:
            ...
            if (PowerDeliveryReqType->ChargingProfile_isUsed == 1u)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (ChargingProfile, ChargingProfileType); next=418
    ...
    while(!done)
    {
        ...
        case 422:
            ...
            if (ChargeParameterDiscoveryResType->SAScheduleList_isUsed == 1u)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (SAScheduleList, SASchedulesType); next=423
            ...
            else if (ChargeParameterDiscoveryResType->SASchedules_isUsed == 1u)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Abstract element or type: START (SASchedulesType); next=423
...
static int encode_iso2_ServiceDiscoveryResType(exi_bitstream_t* stream, const struct iso2_ServiceDiscoveryResType* ServiceDiscoveryResType) {
    ...
    while(!done)
    {
        ...
        case 425:
            ...
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (PaymentOptionListType); next=426
        ...
        case 426:
            ...
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (ServiceType); next=427
...
static int encode_iso2_BodyType(exi_bitstream_t* stream, const struct iso2_BodyType* BodyType) {
    ...
    while(!done)
    {
        ...
        {
        case 430:
            // Grammar: ID=430; read/write bits=6; START (AuthorizationReq)
...
static int encode_iso2_V2G_Message(exi_bitstream_t* stream, const struct iso2_V2G_Message* V2G_Message) {
    ...
    while(!done)
    {
        ...
        case 431:
            ...
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (MessageHeaderType); next=432
